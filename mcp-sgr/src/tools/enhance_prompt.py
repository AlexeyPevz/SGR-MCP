...
async def enhance_prompt_tool(
    ...
    try:
        ...
        if enhancement_level == "minimal":
            enhanced_prompt = await _minimal_enhancement(
                original_prompt, prompt_analysis, schema
            )
            ...
            enhanced_prompt = await _standard_enhancement(
                original_prompt, prompt_analysis, schema
            )
...
async def _minimal_enhancement(
    original: str,
...
async def _standard_enhancement(
    original: str,
    analysis: Dict[str, Any],
    schema: Any
) -> str:
