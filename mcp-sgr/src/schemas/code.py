...
class CodeGenerationSchema(BaseSchema):
    ...
    def get_description(self) -> str:
        return (
            "Structured code generation including requirements, design, implementation, and testing"
        )
        ...
        return [
            {
                ...
                "design": {
                    ...
                    "interfaces": [
                        ...
                        {"name": "RateLimitBackend", "methods": ["get", "set", "incr", "expire"]},
                    ],
                    "data_flow": [
                ...
                "implementation": {
                    "language": "python",
                    "framework": "FastAPI",
                    "dependencies": ["redis>=4.5.0", "fastapi>=0.100.0", "pydantic>=2.0"],
                    "structure": {
                        "files": [
            ...
            "properties": {
                ...
                "validation": {
                    ...
                    "properties": {
                        ...
                        "test_cases": {"type": "array", "items": {"type": "string"}, "minItems": 1},
                        "performance_tests": {"type": "array", "items": {"type": "string"}},
