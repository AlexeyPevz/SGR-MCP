...
class PlanningSchema(BaseSchema):
    ...
    def get_description(self) -> str:
        return (
            "Structured planning including approach, steps, alternatives, and resource requirements"
        )
    ...
    def get_fields(self) -> List[SchemaField]:
        return [
            ...
            SchemaField(
                name="resources", type="object", description="Required resources", required=True
            ),
            SchemaField(
        ...
        return {
            ...
            "properties": {
                "approach": {
                    ...
                    "properties": {
                        "strategy": {"type": "string", "description": "High-level strategy"},
